...
print("\\centering")
print("\\caption{Trigger efficiencies for $B^+ \\to \\bar{\\Lambda}^0_{\\text{LL}} p K^+ K^-$ selection (\\%)}")
...
print("\\begin{table}[htbp]")
print("\\centering")
print("\\caption{Trigger efficiencies for $B^+ \\to \\bar{\\Lambda}^0_{\\text{DD}} p K^+ K^-$ selection (\\%)}")
print("\\begin{tabular}{l|ccc}")
print("\\hline")
print("Levels & 2016 & 2017 & 2018 \\\\ \\hline")
