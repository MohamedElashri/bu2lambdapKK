...
def mock_efficiencies() -> Dict[str, Dict[str, Dict[str, float]]]:
    ...
    return {
        "jpsi": {
            ...
            "2017": {"eff": 0.87, "err": 0.028}
        },
        "etac": {
            "2016": {"eff": 0.75, "err": 0.04},
            "2017": {"eff": 0.77, "err": 0.038}
        },
        "chic0": {
            "2016": {"eff": 0.80, "err": 0.035},
            "2017": {"eff": 0.82, "err": 0.033}
        },
        "chic1": {
            "2016": {"eff": 0.78, "err": 0.036},
            "2017": {"eff": 0.80, "err": 0.034}
        },
        "etac_2s": {
            "2016": {"eff": 0.78, "err": 0.036},
            "2017": {"eff": 0.80, "err": 0.034}
...
class TestEfficiencyCorrectedYield:
    ...
    def test_corrected_yield_includes_all_years(
        ...
        year_2016_corrected = mock_yields["2016"]["etac"][0] / mock_efficiencies["etac"]["2016"]["eff"]
        year_2017_corrected = mock_yields["2017"]["etac"][0] / mock_efficiencies["etac"]["2017"]["eff"]
...
class TestRatioToJpsi:
    ...
    def test_ratio_formula_correctness(
        self, mock_yields, mock_efficiencies, mock_config
    ) -> None:
    ...
    def test_ratio_error_propagation(
        self, mock_yields, mock_efficiencies, mock_config
    ) -> None:
