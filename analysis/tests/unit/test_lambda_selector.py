...
class TestLambdaCuts:
    ...
    def test_apply_cuts_passing_events(self, mock_config_with_lambda_cuts, mock_events_passing) -> None:
    ...
    def test_apply_cuts_failing_events(self, mock_config_with_lambda_cuts, mock_events_failing) -> None:
...
class TestBuMassCuts:
    ...
    def test_missing_bu_mm_corrected(self, mock_config_with_lambda_cuts) -> None:
        ...
        events = ak.Array({
            "Bu_MM": np.array([5279.0])  # Wrong branch name
        })
