...
class TestCacheWithRealWorkflow:
    ...
    def test_pipeline_phase_caching_workflow(self, tmp_cache_dir, config_dir_fixture):
        ...
        cache.save("phase2_data", phase2_data, dependencies=phase2_deps,
        ...
        cache.save("phase3_cuts", phase3_cuts, dependencies=phase3_deps,
