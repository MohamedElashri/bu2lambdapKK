...
class TestFileIOErrors:
    ...
    def test_missing_config_file(self, tmp_test_dir: Path) -> None:
        ...
        assert (
            "fitting.toml" in str(exc_info.value).lower()
...
class TestErrorMessages:
    ...
    def test_configuration_error_message_format(self) -> None:
        ...
        error = ConfigurationError("Missing required parameter 'jpsi_mass' in physics.toml")
    ...
    def test_validation_error_includes_details(self) -> None:
        ...
        error = ValidationError("Yield value is negative: -10.5 for jpsi 2016")
